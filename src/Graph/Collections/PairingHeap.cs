...
{
    public sealed class PairingNode<T> : IHeapNode<T>
    {
        public T Item { get; }
    ...
    public sealed class PairingHeap<T> : IHeap<T>
    {
        ...
        public IHeapNode<T> Insert(T item)
        {
            if (object.ReferenceEquals(item, null))
            {
                throw new ArgumentNullException(nameof(item));
        ...
        public IHeapNode<T> Find(T item)
        {
            if (object.ReferenceEquals(_head, null))
            {
                throw new InvalidOperationException("The heap is empty.");
        ...
        public IHeapNode<T> UpdateItem(IHeapNode<T> heapNode, T item)
        {
            if (object.ReferenceEquals(heapNode, null))
            {
                throw new ArgumentNullException(nameof(heapNode));
            }
            if (object.ReferenceEquals(item, null))
            {
                throw new ArgumentNullException(nameof(item));
            ...
            var node = heapNode as PairingNode<T>;
            if (object.ReferenceEquals(node, null))
            {
                throw new InvalidOperationException("Invalid node type for heap.");
            }
        ...
        public List<IHeapNode<T>> ToList()
        {
            var list = new List<IHeapNode<T>>();
            if (object.ReferenceEquals(_head, null))
            {
                return list;
            }
